...
// DEMO-режим (без реального Supabase) — чтобы визуально полистать шаблон офлайн.
// Логин demo@kt.com / demo123. Убрать перед интеграцией с нашим бэком.
const DEMO_AUTH = true;
const DEMO_USER = {
  id: 'demo-1', email: 'demo@kt.com', username: 'aurix',
  first_name: 'AURIX', last_name: 'Admin', fullname: 'AURIX Admin',
  is_admin: true, is_active: true,
  pic: 'https://ui-avatars.com/api/?name=AURIX&background=D4AF37&color=000',
};
const DEMO_AUTH_OBJ = { access_token: 'demo-token', refresh_token: 'demo-refresh' };
...
export const SupabaseAdapter = {
  ...
  async login(email, password) {
    if (DEMO_AUTH) return DEMO_AUTH_OBJ;
