    ...
    <>
      <div className="page-head">
        <div className="container">
          ...
          <h1>Аренда авто <em>для фотосессий</em></h1>
          ...
          <div style={{ display: 'flex', gap: 18, marginTop: 28, flexWrap: 'wrap' }}>
            ...
            <Link to="/catalog" className="btn">Смотреть автопарк</Link>
          </div>
        </div>
      </div>
      ...
      <section>
        <div className="container">
          <div className="section-head">
            <div className="row-eyebrow"><span className="bar"></span><span className="eyebrow">Как это работает</span></div>
            <h2>Просто и <em>быстро</em></h2>
          </div>
          <div className="services-grid" style={{ marginBottom: 56 }}>
            <div className="service"><div className="ico-wrap"><i className="ph-fill ph-calendar-check" /></div><h3>1. Выберите авто и время</h3><p>Любой автомобиль из списка ниже. Минимальная аренда — 1 час. Возможна съёмка день в день — уточните у менеджера.</p></div>
            <div className="service"><div className="ico-wrap"><i className="ph-fill ph-map-pin" /></div><h3>2. Подача к месту съёмки</h3><p>Привезём автомобиль в любую точку Москвы и МО — студия, парк, набережная, площадка мероприятия.</p></div>
            <div className="service"><div className="ico-wrap"><i className="ph-fill ph-camera" /></div><h3>3. Снимайте</h3><p>Машина в вашем распоряжении на время съёмки. Фотограф, свет, декор — на ваше усмотрение. Поездки — по договорённости.</p></div>
          </div>
